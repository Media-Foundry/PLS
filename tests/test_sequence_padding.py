...
class SequencePaddingTests(unittest.TestCase):
 def test_pooling_predictions_ignore_extra_padding(self):
  ...
  for pooling in ('attention','conditioned_attention','tcn_conditioned_attention','shift_tcn_conditioned_attention','bilstm_textcnn','conv_attention','local_attention','multi_query_pooling','statistics_attention'):
