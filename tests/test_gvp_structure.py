...
class GVPStructureTests(unittest.TestCase):
 def test_data_adapter_preserves_surface_components_before_vectors(self):
  base=tuple(range(9));adapted=attach_vectors(base,'vectors','coords');self.assertEqual(adapted,(0,1,2,3,4,5,6,7,'vectors','coords',8))
