...
class ResidueSequenceRegressor(nn.Module):
 ...
 def forward(self,global_embedding,residues,mask):
  ...
  global_encoded=self.global_encoder(global_embedding);features=(global_encoded,pooled,global_encoded*pooled,(global_encoded-pooled).abs()) if self.fusion=='interaction' else (global_encoded,pooled)
