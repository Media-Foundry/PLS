...
def main():
 ...
 with open(d['observation_split'],newline='',encoding='utf-8') as h:
  for r in csv.DictReader(h):
   if r['source_dataset']=='eSOL_FGNNSol' and r['split'] in rows:rows[r['split']].append((index[r['sequence_sha256']],float(r['target_value'])))
 ...
 print(json.dumps({'best_epoch':state['epoch'],'best_validation_spearman':best,'test_evaluated':False}))
