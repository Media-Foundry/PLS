...
def main() -> None:
    ...
    parser.add_argument("--pooling-override", choices=("mean", "attention", "conditioned_attention", "tcn_conditioned_attention", "shift_tcn_conditioned_attention", "gated_shift_tcn_conditioned_attention", "bilstm_textcnn", "segment_transformer", "multihead_attention", "multi_query_pooling", "statistics_attention", "gated_statistics_attention", "multiscale_attention", "conv_attention", "local_attention", "plddt_gate", "dual_patch", "surface_patches"))
    ...
    if args.patch_aux_weight_override is not None:
    ...
    if args.physchem_sparse_residual_override is not None:
