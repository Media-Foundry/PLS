...
def main():
 p=argparse.ArgumentParser();p.add_argument('run_dirs',nargs='+',type=Path);p.add_argument('--output',type=Path,required=True);p.add_argument('--task',choices=('pdbsol','uesolds'));p.add_argument('--calibration-candidates',type=int,default=256);a=p.parse_args();loaded=[]
